...
class SalataVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidAppear(_ animated: Bool) {
        selectedName = ""
        NotificationCenter.default.addObserver(self, selector: #selector(getData), name: NSNotification.Name("salata"), object: nil)
    }
    ...
    @objc func getData() {
        ...
        let getData = NSFetchRequest<NSFetchRequestResult>(entityName: "SalataTarifleri")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let newCell = table.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! SalataTableViewCell
        newCell.imageSalataCell.image = UIImage(data: imageArray[indexPath.row])
        newCell.tarifadiSalataCell.text = tarifAdiArray[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "toSalataDetailVC", sender: nil)
    }

    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toSalataDetailVC" {
            let destinatonVC = segue.destination as! SalataDetailVC
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            let appDelegate = UIApplication.shared.delegate as! AppDelegate
            let context = appDelegate.persistentContainer.viewContext
            let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "SalataTarifleri")

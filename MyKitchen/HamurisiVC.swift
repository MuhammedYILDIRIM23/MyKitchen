...
class HamurisiVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidAppear(_ animated: Bool) {
        selectedName = ""
        NotificationCenter.default.addObserver(self, selector: #selector(getData), name: NSNotification.Name("hamurisi"), object: nil)
    }
    ...
    @objc func getData() {
        ...
        let getData = NSFetchRequest<NSFetchRequestResult>(entityName: "HamurisiTarifleri")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let newCell = table.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! HamurisiTableViewCell
        newCell.imageHamurisiCell.image = UIImage(data: imageArray[indexPath.row]) //important
        newCell.tarifadiHamurisiCell.text = tarifAdiArray[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "toHamurisiDetailVC", sender: nil)
    }
    
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toHamurisiDetailVC" {
            let destinatonVC = segue.destination as! HamurisiDetailVC
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            let appDelegate = UIApplication.shared.delegate as! AppDelegate
            let context = appDelegate.persistentContainer.viewContext
            let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "HamurisiTarifleri")
    ...
    func navigationBarLogo() {
        let logo = UIImage(named: "hamurisi")

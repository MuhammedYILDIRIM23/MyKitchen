...
class TatliVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidAppear(_ animated: Bool) {
        selectedName = ""
        NotificationCenter.default.addObserver(self, selector: #selector(getData), name: NSNotification.Name("tatli"), object: nil)
    }
    ...
    @objc func getData() {
        ...
        let getData = NSFetchRequest<NSFetchRequestResult>(entityName: "TatliTarifleri")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let newCell = table.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! TatliTableViewCell
        newCell.imageTatliCell.image = UIImage(data: imageArray[indexPath.row]) //important
        newCell.tarifadiTatliCell.text = tarifAdiArray[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "toTatliDetailVC", sender: nil)
    }
    
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toTatliDetailVC" {
            let destinatonVC = segue.destination as! TatliDetailVC
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            let appDelegate = UIApplication.shared.delegate as! AppDelegate
            let context = appDelegate.persistentContainer.viewContext
            let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "TatliTarifleri")

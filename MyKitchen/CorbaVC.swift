...
class CorbaVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidAppear(_ animated: Bool) {
        selectedName = ""
        NotificationCenter.default.addObserver(self, selector: #selector(getData), name: NSNotification.Name("corba"), object: nil)
    }
    ...
    @objc func getData() {
        ...
        let getData = NSFetchRequest<NSFetchRequestResult>(entityName: "CorbaTarifleri")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let newCell = table.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! CorbaTableViewCell
        newCell.imageCorbaCell.image = UIImage(data: imageArray[indexPath.row]) //important
        newCell.tarifadiCorbaCell.text = tarifAdiArray[indexPath.row]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "toCorbaDetailVC", sender: nil)
    }
    
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toCorbaDetailVC" {
            let destinatonVC = segue.destination as! CorbaDetailVC
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "CorbaTarifleri")
